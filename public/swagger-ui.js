...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.render = function() {
      var contentTypeModel, isMethodSubmissionSupported, k, o, param, responseContentTypeView, responseSignatureView, signatureModel, statusCode, type, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4;
      ...
      if (this.model.authorizations) {
        ...
        for (k in _ref) {
          v = _ref[k];
          if (k === "oauth2") {
            if (((_ref1 = this.model.oauth) != null ? _ref1.scopes : void 0) == null) {
              this.model.oauth = {
                scopes: []
              };
            }
